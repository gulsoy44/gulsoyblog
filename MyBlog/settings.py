...
SECRET_KEY = 'django-insecure-t+y17c7s6784yzxf%gthqoowd*p2(hj0f-&$l%v8%kfh0x4nm^'
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        conn_max_age=600,
        ssl_require=True  # Ensure SSL connection on Render
    )
}
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Where your CSS/JS lives during dev
]

# Enable WhiteNoise static file compression (optional but recommended)
...
if not DEBUG:
    #STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')
    STATIC_ROOT = '/usr/home/gulsoya/public_html/static'
